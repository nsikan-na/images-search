...
export default function Results() {
  return (
    <div className="text-center ">
      <div className="w-screen bg-gray-50 pb-10">
        <div className=" mx-auto bg-white shadow-md w-10/12">
          <div className="mx-auto w-8/12 ">
            <h2 className="font-bold text-4xl pt-10 pb-6">Your Results</h2>
            <div className="text-gray-500 font-bold text-xl w-10/12">
              {" "}
              ESTIMATED RETIREMENT SAVINGS
            </div>
            <p className="w-6/12 font-semibold text-lg">
              In 19 years, your investment could be worth:
            </p>
            <div className="py-0.5 bg-gray-50 my-5"></div>
            <div className="text-center">
      ...
      <div className='w-9/12 mx-auto pb-10'>
        ...
        <div>
          ...
          <div className="font-bold text-xl text-gray-700 mb-2">GAVE UP WEEKLY RESTAURANT VISITS.</div>
          <p className="text-xl text-gray-700 mb-2">
